...
public class QEventHandlerCheckVersionTest {
	...
	public void testParameters() {
		...
		QEventHandler q = new QEventHandlerCheckVersion();
		QEventCheckVersion eventCV = new QEventCheckVersion(goodVersion,goodVersion);
		
		/* Fail in the super class */
		JSONObject json = q.checkParameters(0,eventCV);
		...
		/* Ok! */
		eventCV = new QEventCheckVersion(goodVersion,goodVersion);
	...
	public void testOnEvent() {
		QEventHandlerCheckVersion q = new QEventHandlerCheckVersion();
		QEventCheckVersion event = new QEventCheckVersion(goodVersion,badVersion);
		...
		/* Ok! */
		event = new QEventCheckVersion(goodVersion,goodVersion);
		json = q.checkParameters(0,event);
		assertTrue(json == null);
