...
public class QAPIEvent_CheckSession_Test {
	...
	public void test() {
		...
		try{
			...
			QAPIEvent_CheckSession a = new QAPIEvent_CheckSession(version,null);
			QAPIEvent_CheckSession b = (QAPIEvent_CheckSession) a.clone();
			
			QAPIEvent_VersionCheck c = new QAPIEvent_VersionCheck(version);
	...
	public void testWebServerSocket() {
		...
		ws.updateAPIRegistry("/session/kill", new QAPIEvent_KillSession(version,db));
		ws.updateAPIRegistry("/session/check", new QAPIEvent_CheckSession(version,db));
		...
		/**** Now test get_patients to validate sessions****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test check session with missing params****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test check session with bad session params****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test check session with good session params****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
