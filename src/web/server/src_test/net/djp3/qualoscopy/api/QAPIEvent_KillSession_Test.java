...
public class QAPIEvent_KillSession_Test {
	...
	public void test() {
		...
		try{
			...
			QAPIEvent_KillSession a = new QAPIEvent_KillSession(version,null);
			QAPIEvent_KillSession b = (QAPIEvent_KillSession) a.clone();
	...
	public void testWebServerSocket() {
		...
		/**** Now test kill session with bad session params****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test kill session with good session params****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test add_patients to prove session was killed ****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
