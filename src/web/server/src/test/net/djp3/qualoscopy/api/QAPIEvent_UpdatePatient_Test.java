...
public class QAPIEvent_UpdatePatient_Test {
	...
	public void test() {
		...
		try{
			...
			QAPIEvent_UpdatePatient a = new QAPIEvent_UpdatePatient(version,null);
			QAPIEvent_UpdatePatient b = (QAPIEvent_UpdatePatient) a.clone();
	...
	public void testWebServerSocket() {
		...
		ws.updateAPIRegistry("/update/patient", new QAPIEvent_UpdatePatient(version,db));
		...
		/**** Now test update patients with missing params ****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
									.setHost("localhost")
									.setPort(ws.getInputChannel().getPort())
									.setPath("/update/patient")
									.setParameter("version", version)
									.setParameter("user_id","test_user")
									.setParameter("shsid",SHA256.sha256(session_id+salt,1))
									.setParameter("shsk",SHA256.sha256(session_key+salt,1))
									.setParameter("patient_id",patient_id)
									//.setParameter("mr_id",SHA256.makeSomethingUp())
									.setParameter("last",SHA256.makeSomethingUp())
									.setParameter("first",SHA256.makeSomethingUp())
									.setParameter("dob","1/1/2015")
		...
		/**** Now test update patients with bad gender ****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test update patients with bad dob ****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
		...
		/**** Now test update patients with bad session****/
		responseString = null;
		try {
			URIBuilder uriBuilder = new URIBuilder()
									.setScheme("http")
